...
export default function AllReports() {
  ...
  return (
    <div>
      <h1 style={{ color: '#fff', fontSize: '1.3rem', fontWeight: 900, marginBottom: '20px' }}>All <span style={{ color: '#a78bfa' }}>Reports</span></h1>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.82rem' }}>
          <thead>
            <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
              {['Student', 'Week', 'Title', 'Date', 'Status', 'Score'].map(h => (
          ...
          <tbody>
            {reports.length === 0
              ? <tr><td colSpan={6} style={{ padding: '24px', textAlign: 'center', color: '#555' }}>No reports found</td></tr>
              : reports.map((r, i) => (
